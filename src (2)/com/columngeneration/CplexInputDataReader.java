...
public class CplexInputDataReader {
    ...
    String _fileName;
    //开始读数据
    public CplexInputDataReader(String fileName) throws IOException {
    ...
    //读取double型数据
    public double readDouble() throws InputDataReaderException,
            IOException {
        //读取下一个内容
