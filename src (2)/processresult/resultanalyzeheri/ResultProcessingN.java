...
//            System.out.println("nameLB   " + name);
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (int m = 1; m < 5; m++) {
            // String str1 = "E:\\同步文件\\BaiduSyncdisk\\小论文\\结果集\\启发式算法集\\启发式结果集\\ResultData0" + m + "\\BKW_Def";
            String str1 = "E:\\同步文件\\BaiduSyncdisk\\小论文\\结果集\\启发式算法集\\改进放置位置后的启发式结果集\\ResultData0" + m + "\\BKW_Def";
            System.out.println("--------");
            File fileVar = new File(str1);
            File fileLB = new File("E:\\同步文件\\BaiduSyncdisk\\小论文\\处理结果集\\数据处理\\BKW.txt");
            // 读取LB
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                if (index == 0) {
                    for (int j = 1; j <= files1.length; j++) {
                        ...
                        // 下界计算法
                        double nowLB1 = resultProcessingN.lbo(files1[j - 1].getAbsolutePath());
